...
void TriPyramidModel::privCreateVAO(const char * const pModelFileName)
{
	File::Handle fh2;
	File::Error  ferror;
...
TriPyramidModel::TriPyramidModel(const char * const pModelFileName)
	: Model()
{
...
TriPyramidModel::~TriPyramidModel()
{
